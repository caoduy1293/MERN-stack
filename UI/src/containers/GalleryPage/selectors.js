...
const makeSelectTypes = () => createSelector(selectApp, appState => appState.get('types').toArray());

export { selectApp, makeSelectData, makeLoading, makeSelectListData, makeSelectTypes };
